...
const MOCK_CREATORS: (Creator & { category: string; featured: boolean })[] = [
  {
    id: 'mock-1',
    user_id: 'u1',
  ...
  },
  {
    ...
    price_clp: 14990,
    plan: 'pro',
    publish_frequency: 'Quincenal',
    created_at: '2024-05-01T00:00:00Z',
    subscriber_count: 421,
    stripe_account_id: null,
    category: 'Economía',
    featured: true,
  },
