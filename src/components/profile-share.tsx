...
export function ProfileShare({ slug, publicationName, creatorName, specialty, bio }: ProfileShareProps) {
  ...
  return (
    <div className="flex items-center gap-1.5 flex-wrap">
      ...
      {canNativeShare && (
        <IconBtn onClick={handleNativeShare} title="Compartir" color="hover:bg-[#111] hover:text-white">
      ...
      {/* LinkedIn */}
      <IconLink href={links.linkedin} title="LinkedIn" color="hover:bg-[#0A66C2] hover:text-white">
      ...
      {/* WhatsApp */}
      <IconLink href={links.whatsapp} title="WhatsApp" color="hover:bg-[#25D366] hover:text-white">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* X / Twitter */}
      <IconLink href={links.twitter} title="X / Twitter" color="hover:bg-[#111] hover:text-white">
      ...
      {/* Facebook */}
      <IconLink href={links.facebook} title="Facebook" color="hover:bg-[#1877F2] hover:text-white">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Messenger */}
      <IconLink href={links.messenger} title="Messenger" color="hover:bg-[#0078FF] hover:text-white">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.652V24l4.088-2.242c1.092.3 2.246.464 3.443.464 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26 6.561-6.96 3.129 3.26 5.889-3.26-6.561 6.96z"/>
        </svg>
      </IconLink>

      {/* Telegram */}
      <IconLink href={links.telegram} title="Telegram" color="hover:bg-[#26A5E4] hover:text-white">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Reddit */}
      <IconLink href={links.reddit} title="Reddit" color="hover:bg-[#FF4500] hover:text-white">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Threads */}
      <IconLink href={links.threads} title="Threads" color="hover:bg-[#111] hover:text-white">
      ...
      {/* Email */}
      <IconLink href={links.email} title="Correo electrónico" color="hover:bg-[#444] hover:text-white">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Copiar link */}
      <IconBtn onClick={handleCopy} title={copied ? 'Copiado' : 'Copiar link'} color={copied ? 'bg-[#1A5C38] text-white' : 'hover:bg-[#111] hover:text-white'}>
        {copied
...
function IconLink({ href, title, color, children }: { href: string; title: string; color: string; children: React.ReactNode }) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" title={title}
      className={`w-8 h-8 flex items-center justify-center border border-[#DEDEDE] text-[#555] transition-colors ${color}`}>
      {children}
    </a>
  )
}
